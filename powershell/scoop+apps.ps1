...
# Utilities
scoop install 7zip tar unrar zip unzip processhacker kitty lynx make youtube-dl nmap autoruns cmdow fciv windirstat winscp speedcrunch qbittorrent oraclejre keepassxc
